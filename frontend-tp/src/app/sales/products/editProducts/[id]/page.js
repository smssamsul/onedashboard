...
import JadwalPreview from '../../addProducts3/components/JadwalPreview';
  ...
  const fetchProductData = async () => {
    ...
    try {
      ...
      setPengaturanForm({
        ...
        unit_bisnis: produkData.unit_bisnis ? String(produkData.unit_bisnis) : null,
