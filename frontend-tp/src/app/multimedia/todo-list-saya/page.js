...
export default function MultimediaTodoListSayaPage() {
  ...
  const checkAccess = () => {
    try {
      ...
      if (userDivisi !== 7 && userDivisi !== "7" && userDivisi !== "multimedia" && userDivisi !== "mm") {
        alert("Akses ditolak. Hanya Multimedia yang dapat mengakses halaman ini.");
  ...
  if (!isAuthorized) {
    return (
      <Layout title="Todo List Saya | Multimedia">
