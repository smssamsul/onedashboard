...
export default function TodoListPage() {
  ...
  useEffect(() => {
    // Try both token keys for compatibility - prioritize "token" as it's used in login
    ...
    if (token && userData) {
      ...
      // Only redirect if we're sure there's no token/user data
      router.push("/login");
    }
  ...
  return (
    <Layout title="Todo List Saya | One Dashboard">
