...
export default function SalesStaffTodoListSayaPage() {
  ...
  const checkAccess = () => {
    try {
      ...
      // Divisi 3 = Sales, Level 2 = Staff
      if ((userDivisi !== 3 && userDivisi !== "3" && userDivisi !== "sales") || (userLevel !== 2 && userLevel !== "2")) {
        alert("Akses ditolak. Hanya Staff Sales yang dapat mengakses halaman ini.");
  ...
  if (!isAuthorized) {
    return (
      <Layout title="Todo List Saya | Sales Staff">
