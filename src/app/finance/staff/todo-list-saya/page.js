...
export default function FinanceStaffTodoListSayaPage() {
  ...
  const checkAccess = () => {
    try {
      ...
      // Divisi 4 = Finance, Level 2 = Staff
      if ((userDivisi !== 4 && userDivisi !== "4" && userDivisi !== "finance") || (userLevel !== 2 && userLevel !== "2")) {
        alert("Akses ditolak. Hanya Staff Finance yang dapat mengakses halaman ini.");
        router.push("/finance/staff");
        return;
      }
  ...
  if (!isAuthorized) {
    return (
      <Layout title="Todo List Saya | Finance Staff">
