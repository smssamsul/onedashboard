...
export default function MarketingTodoListSayaPage() {
  ...
  const checkAccess = () => {
    try {
      ...
      if (userDivisi !== 6 && userDivisi !== "6" && userDivisi !== "marketing") {
        alert("Akses ditolak. Hanya Marketing yang dapat mengakses halaman ini.");
  ...
  if (!isAuthorized) {
    return (
      <Layout title="Todo List Saya | Marketing">
